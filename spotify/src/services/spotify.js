...
const clientId = "5cfd744bb1924a73aecbab438e2064ce"; // your clientId

const redirectUrl = "http://localhost:3000"; // your redirect URL - must be localhost URL and/or HTTPS
// const redirectUrl = "https://birdspot.netlify.app/";
...
export async function getUserSaveTracks() {
  return await fetchWebApi("v1/me/tracks", "GET");
}
export async function getUserPlaylist(userId) {
  return await fetchWebApi(`v1/users/${userId}/playlists`, "GET");
}
...
export async function GetRecommendations(
  ...
  return await fetchWebApi(
    `v1/recommendations?seed_tracks=${seed_tracks}&min_duration_ms=${min_duration_ms}&max_duration_ms=${max_duration_ms}&min_popularity=${min_popularity}&max_popularity=${max_popularity}`,
    "GET"
  );
}
